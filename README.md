...
- Words beginning with a consonant that consonant moved to the end of the word and followed by "ay". *Examples: "pig" -> "igpay", "javascript" -> "avascriptjay"* 
- Groups of consonants are moved together. *Examples: "string" -> "ingstray", "slice" -> "iceslay"*
- Words that begin in vowels should just get "yay" added to the end. *Examples: "object" -> "objectyay",  "array" -> "arrayyay"*
